/* Name: 2_4_2_code_jonlee27.c
 * Author: Jonathan Lee
 * Description: Code for MEAM5100 Lab 2.4.2
 */
...
int main(void) {
    ...
    for (;;) {
        ...
        int i;
        int found = 0;  // if frequency is found
        for (i = 0; i < 20; i++) {
        ...
        // turn off LEDs if neither frequency is found
        if (!found) {
            clear(PORTB, 7);
            clear(PORTB, 6);
        }
